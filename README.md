...
1. How would you describe preprocessing to someone new to CSS?
    ...
    Preprocessing allows us to use CSS to its potential. converts LESS or SASS into CSS for the use of styling html

2. What is your favorite concept in preprocessing? What is the concept that gives you the most 
trouble?

    the concept of preprocessing make sense, it is very useful for many aspects, the trouble is trying to set the preprocessor up for proper use

3. How would you explain the concept of a variable to someone new to programming?

    variables vary, reason why they are called variables, you can name variables. think of a box with one item in it. can be replaced with something else over time.

    you can give a variable a value using "=" it is more of an assignement.

4. What is the purpose of using functions in code?

    makes our life easier to write the code in the function once, and call upon it from many places

5. What is a JSON data?


    JavaScript Object Notation is a standard file format for many modern programming languages
